	  ...
	  <div class="row">
		...
		<div class="col-lg-5 offset-lg-1">
		  <div class="owl-banner owl-carousel">
			<div class="item">
			  <img src="{{ asset('images/banner-01.png')}}" alt="Баннер 1"/>
			</div>
			<div class="item">
			  <img src="{{ asset('images/banner-02.png')}}" alt="Баннер 2"/>
			</div>
		  </div>
		</div>
	  </div>
	  ...
	  <div class="row">
		...
		<div class="col-lg-4">
		  <div class="main-button">
			<a href="{{ route('home.ads.create.page') }}">Добавить модель</a>
		  </div>
		</div>
		<div class="col-lg-4">
		  <div class="item first-item">
			<div class="icon">
			  <img src="{{ asset('images/icon-02-new.png')}}" alt="Иконка 2"/>
			</div>
			<h4>Зарегистрируйтесь</h4>
			<p>Зарегистрируйте новый профиль за пару минут на соответствующей 
			  <a href="{{ route('register') }}">странице</a>
			</p>
		  </div>
		</div>
		<div class="col-lg-4">
		  <div class="item second-item">
			<div class="icon">
			  <img src="{{ asset('images/icon-04-new.png')}}" alt="Иконка 4"/>
			</div>
			<h4>Добавьте модель</h4>
			<p>
			  <a href="{{ route('home.ads.create.page') }}">Добавьте</a>
			  модель на площадку, указав все характеристики и цену
			</p>
		  </div>
	    </div>
		<div class="col-lg-4">
		  <div class="item">
			<div class="icon">
			  <img src="{{ asset('images/icon-06-new2.png')}}" alt="Иконка 6"/>
			</div>
			<h4>Продавайте и покупайте</h4>
			<p>Ждите прибыли, либо покупайте модели других пользователей для своих проектов</p>
		  </div>
	    </div>
	  </div>
    </div>
