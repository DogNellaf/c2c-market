		...
		<div class="row">
		  <div class="col-12">
			<nav class="main-nav">
			  ...
			  <ul class="nav">
				<li>
					<a href="{{ route('main.index') }}" class="@yield('index_active')">Главная</a>
				</li>
				<li>
					<a href="{{ route('main.ads.list') }}" class="@yield('ads_active')">Модели</a>
				</li>
				@guest
				  <li>
					<a href="{{ route('register') }}" class="@yield('register_active')">Регистрация</a>
				  </li>
				  <li>
					<a href="{{ route('login') }}" class="@yield('login_active')">Вход</a>
				  </li>
				@endguest
				@auth
